...
function Profile() {
  ...
  return (
    ...
    <div>
    <NavBar ntype={"user"} nid={user_id}/>
    <div class="wrapper">
    <div class="profile-card js-profile-card">
      <div class="profile-card__img">
        <img src="https://w7.pngwing.com/pngs/831/88/png-transparent-user-profile-computer-icons-user-interface-mystique-miscellaneous-user-interface-design-smile-thumbnail.png" alt="profile card"/>
      </div>
      <div class="profile-card__cnt js-profile-cnt">
        <div class="profile-card__name">{userDetails.first_name}{userDetails.last_name}</div>
        <div class="profile-card__txt">{userDetails.degree} Graduate <strong></strong></div>
        ...
        <div class="profile-card-inf">
          <div class="profile-card-inf__item">
            <div class="profile-card-inf__title">Skills</div>
            <div class="profile-card-inf__txt">{userDetails.skills}</div>
          </div>
  
          <div class="profile-card-inf__item">
            <div class="profile-card-inf__title">Branch</div>
            <div class="profile-card-inf__txt">{userDetails.branch}</div>
          </div>
          <div class="profile-card-inf__item">
            <div class="profile-card-inf__title">Experience</div>
            <div class="profile-card-inf__txt">{
              userDetails.experience >0? userDetails.experience:"Fresher"}</div>
          </div>
        </div>
        <div class="profile-card-social">
       
          <a href="https://twitter.com/sankarsiva" class="profile-card-social__item twitter" target="_blank">
            <span class="icon-font">
                <svg class="icon"><use xlinkHref="#icon-twitter"></use></svg>
            </span>
          </a>
          <a href="https://github.com/SivasankarKuppusamy" class="profile-card-social__item github" target="_blank">
            <span class="icon-font">
                <svg class="icon"><use xlinkHref="#icon-github"></use></svg>
            </span>
          </a>
  
          <a href="https://codepen.io/SivasankarKuppusamy" class="profile-card-social__item codepen" target="_blank">
            <span class="icon-font">
                <svg class="icon"><use xlinkHref="#icon-codepen"></use></svg>
            </span>
          </a>
        </div>
  {type ? <a href='tel:$userDetails.mobile'><button class="profile-card__button button--blue js-message-btn">Contact</button></a>:
        <div class="profile-card-ctr">
        <button class="profile-card__button button--blue js-message-btn">Update</button>
          <button class="profile-card__button button--orange">Logout</button>
        </div>
      }
      </div>
